...
const stats = [
  { label: 'Nominations', value: '11,175', note: 'Submitted across 30+ categories' },
  { label: 'Votes', value: '6,021', note: 'Industry professionals participated' },
  { label: 'Winners', value: '50', note: 'Shops recognized during the annual cycle' },
];
    ...
    <section id="welcome" className="welcome-section section-pad">
      <div className="content-wrap">
        <div className="welcome-header">
          ...
          <h2>Top Shop Awards is one of the most coveted aviation maintenance awards in the world</h2>
          <p className="welcome-header-copy">
            For nearly two decades, the program has spotlighted repair facilities that keep raising
            the standard for quality, innovation, and customer support.
          </p>
        </div>
        ...
        <div className="welcome-grid">
          <aside className="welcome-profile">
            <div className="welcome-photo-wrap">
              <Image
                src="/assets/images/about/justin.jpg"
            ...
            <div className="welcome-profile-note">
              <p>
                The Top Shop Awards were created to celebrate organizations that consistently set
                the benchmark for excellence in aviation maintenance.
              </p>
            </div>
          </aside>
          ...
          <article className="welcome-copy">
            <p>
              Nineteen years ago, we set out to recognize component repair facilities that
              consistently deliver results exceeding industry standards. Our goal was to honor
              companies that drive innovation, embrace cutting-edge technologies, and provide
              unparalleled customer support within the aviation maintenance sector.
            </p>
            <p>
              Over the years, the Top Shop Awards have evolved into one of the most prestigious
              distinctions in aviation maintenance. To date, 414 awards have been presented across
              as many as thirty different repair categories.
            </p>
