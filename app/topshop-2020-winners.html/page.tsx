...
const winnersCardsHtml = readFileSync(
  join(process.cwd(), 'data', 'topshop_2020_winners_cards.html'),
  'utf8',
);

export const metadata: Metadata = {
  title: '2020 Top Shop Winners | Top Shop Awards',
  description:
    'Official 2020 Top Shop Awards winners by repair category, including winner names and contact details.',
  alternates: {
    canonical: `${SITE_URL}/topshop-2020-winners.html`,
  },
};

export default function Topshop2020WinnersPage() {
  return (
        ...
        <section className="winners-2025-page-title">
          ...
          <div className="section-pad">
            <div className="content-wrap winners-2025-page-title-content">
              <h1>2020 Top Shop Winners</h1>
              <p>
                <Link href="/">Home</Link> / <span>2020 Winners</span>
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="winners-2025-intro section-pad">
          <div className="content-wrap winners-2025-intro-grid is-single">
            <article className="winners-2025-copy">
              <p>
                The official 2020 Top Shop winners are listed below by repair category, including
